...
function drawDisctiption(keyNumber) {
    ...
    asideText.addEventListener('click', editDescription);
    asideText.innerHTML = shortInfoArr[keyNumber].comment;
...
function editDescription() {
    if (iscommentnotredacting) {
        ...
        editButton.addEventListener('click', (e) => {
                if (textarea.value) {
                    shortInfoArr[currentAsideKey].comment = textarea.value;
                } else {
        ...
        textarea.value = shortInfoArr[currentAsideKey].comment;
        innerAside.appendChild(textarea);
